...
We start with some basic definitions for Percolation, specifically bond percolation where we consider the edges on the graph to be either open or closed. 
...
\begin{definition}\emph{d-dimensional cubic lattice}\\
\end{definition}
...
\section{Existence of a critical value on $\mathbb{Z}^d$}
