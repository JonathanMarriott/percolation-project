...
\begin{definition}[Critical Value]
	We define the critical value $p_c$ formally as follows
	$$p_c = \text{sup}\{p \in [0,1]: \theta(p)=0\} $$
\end{definition}
% TODO: #1 -------------CRITICAL VALUE DEF!!!!!
...
% TODO #2 Fill in existance of critcal value on Z^d from Z^2
