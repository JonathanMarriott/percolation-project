...
We let our sample space $\Omega = \prod_{e \in E(\ints^d)} \{0,1\}$ where an edge in state 1 represents it is open, and 0 that it is closed.\\
...
It turns out we can generate the \sigalg by cylinder sets.
