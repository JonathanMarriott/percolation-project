...
\begin{definition}[Increasing Event]
	...
	We notice that the event $\{|C| = \infty\}$ is clearly an increasing event 
...
\begin{proof}
	We use the coupling of probability measures to show that $\prob(A)$ is non-decreasing. We use the definition of couplings given by \cite{roch2015modern}.
	...
	\begin{definition}[Coupling]
		...
		We say $(X,Y)$ coupling of random variables $X,Y$ 
...
{\color{red}{TODO: explain critical value is non-decreasing in d}}
...
\begin{proof}
	...
	{\color{red}{Look at Duminil-Copin notes}}
\end{proof}
